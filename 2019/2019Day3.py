...
inter = findIntersections(wire1_map,wire2_map)

print(wire1_map)
print(wire2_map)
print("Intersections " + str(inter))
inter.sort(key=sortFunc)
print("Sorted intersections " + str(inter))
print("Answer is..." + str(inter[0][0] + inter[0][1]))